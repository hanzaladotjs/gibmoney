const Home = () => {
  return (
    <div className="flex font-mono md:justify-center justify-start md:min-h-150 min-h-120 items-center text-gray-600 font-mono md:mx-0 mx-2 text-6xl">
      <h1 className="flex flex-col md:w-full md:h-full  md:space-x-6 md:flex-row md:justify-center ">
