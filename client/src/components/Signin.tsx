...
const data = await response.json()
   ...
   localStorage.setItem("jwt", token as string)
    ...
    return (
      <div className="flex flex-col justify-center items-center mt-20 md:mt-0  font-mono text-gray-300 opacity-50 hover:border-gray-500 md:py-25 py-16 px-8 md:px-25 mx-2 rounded-3xl">
